...
export const FooterCTA = () => {
  return (
    <footer style={{ background: '#000000', padding: 'clamp(40px, 6vw, 60px) clamp(16px, 4vw, 48px)', position: 'relative', overflow: 'hidden', borderTop: '1px solid rgba(45,212,191, 0.08)' }}>
        ...
        <div style={{ paddingTop: 0 }}>
          <div className="footer-flex" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 32 }}>
            ...
            <div className="footer-right" style={{ textAlign: 'right' }}>
              ...
              <div style={{ fontFamily: 'Outfit, sans-serif', fontSize: 12, color: '#444440', marginTop: 16 }}>Â© 2025 intervieHire. All rights reserved.</div>
            </div>
          </div>
        </div>
      </div>

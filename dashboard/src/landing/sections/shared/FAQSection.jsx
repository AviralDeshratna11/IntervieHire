...
export const FAQSection = () => {
  ...
  return (
    ...
    <section ref={sectionRef} data-scroll id="faq" style={{ background: '#050505', padding: 'clamp(60px, 8vw, 100px) clamp(16px, 4vw, 48px)', borderTop: '1px solid rgba(45,212,191,0.08)' }}>
          ...
          {FAQ_ITEMS.map((faq, idx) => {
            ...
            return (
              <div className="faq-item"
                ...
                key={idx}
                style={{
                  background: isOpen ? 'rgba(45,212,191,0.04)' : 'rgba(255,255,255,0.02)',
                  border: isOpen ? '1px solid rgba(45,212,191,0.2)' : '1px solid rgba(45,212,191,0.1)',
                  boxShadow: isOpen ? '0 0 30px rgba(45,212,191,0.06)' : 'none',
                  borderRadius: 12,
                  overflow: 'hidden',
              ...
              >
                <div 
                  ...
                  style={{
                    ...
                    color: isOpen ? '#2dd4bf' : '#EEEEEE'
                  }}
                >
                  <span>{faq.q}</span>
                  <svg 
                    width="14" height="8" viewBox="0 0 14 8" fill="none"
                    style={{ transform: isOpen ? 'rotate(180deg)' : 'none', transition: 'transform 0.3s ease', color: '#2dd4bf' }}
                  >

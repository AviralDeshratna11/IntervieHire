...
// initRuntime() stashes the three.js namespace on window.THREE for legacy inline
// code that reaches for the global; declare it so that assignment type-checks.
declare global {
  interface Window {
    THREE?: typeof THREE_import;
  }
}
...
export function initRuntime() {
  ...
  MutationObserver = class extends globalThis.MutationObserver {
    constructor(...args: ConstructorParameters<typeof globalThis.MutationObserver>) {
      super(...args);
